<template>
  <body>
    <div class="grid-container">
      <div class="grid-item">
        <div class="store-introduction">
          <h1>Welcome to FashionAura</h1>
        <p>
        At FashionAura, we believe fashion is more than just clothing – it's a statement. 
    ...
    <div  class="grid-item">
    <img src="https://images.unsplash.com/photo-1604882767135-b41fac508fff?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="HomePagePhoto" width="500" height="333">
    </div>
    </div>
 </body>
</template>
