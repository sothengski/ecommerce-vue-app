    ...
    <div class="container">
      ...
      <form @submit.prevent="saveProduct">
        <div class="form-group">
          ...
          <input type="text" id="productSize" v-model="form.productSize" placeholder="e.g., S, M, L, XL" />
  
          <label for="productColor">Product Color:</label>
          <input type="text" id="productColor" v-model="form.productColor" placeholder="e.g., Red, Blue, Green" />
